    ...
    <View className="flex-1 items-center dark:bg-black p-4">
      ...
      <View className="container  bg-white border border-gray-200 rounded-lg dark:bg-gray-900 dark:border-gray-800 ">
        <Pressable
          ...
          onPress={() => configStore.setTheme("system")}
        >
          ...
          <Feather
            ...
            name={configStore.theme == "system" ? "disc" : "circle"}
            size={20}
            color={theme.text}
          />
        </Pressable>
        <Pressable
          className="w-full flex flex-row items-center p-3 dark:border-gray-800"
          onPress={() => configStore.setTheme("light")}
        >
          ...
          <Feather
            ...
            name={configStore.theme == "light" ? "disc" : "circle"}
            size={20}
            color={theme.text}
          />
        </Pressable>
        <Pressable
          className="w-full flex flex-row items-center p-3 dark:border-gray-800"
          onPress={() => configStore.setTheme("dark")}
        >
          ...
          <Feather
            ...
            name={configStore.theme == "dark" ? "disc" : "circle"}
            size={20}
            color={theme.text}
          />
        </Pressable>
        ...
        <View className="container bg-white border border-gray-200 rounded-lg dark:bg-gray-900 dark:border-gray-800 ">
          {timers.map((timer, index) => (
            <Pressable
              key={index}
              className={`w-full flex flex-row items-center p-3 ${
                _.size(timers) != index + 1 && "border-b"
