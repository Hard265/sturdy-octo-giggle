...
export default function Page() {
  return (
    <View className="flex-1 items-center justify-end p-8 dark:bg-black">
      ...
      <Pressable
        className="w-full flex justify-center items-center bg-gray-800 rounded-lg px-5 py-2.5 mb-3 dark:bg-white"
      ...
      <Pressable
        className="w-full flex justify-center items-center py-2.5 px-5 me-2 mb-2 bg-transparent rounded-lg border border-gray-300 dark:bg-transparent dark:border-gray-600"
